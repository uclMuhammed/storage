...
class ProductUnits extends BaseModel<ProductUnits> {
  ...
  factory ProductUnits.update(String description, double quantity, bool? isActive) {
    return ProductUnits(
      unit: 0,
      description: description,
      quantity: quantity,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'ISACTIVE': isActive,
      'ISDELETE': isDelete,
      'CREATEDAT': createdAt.toIso8601String(), // DateTime'ı string'e çevir
      'CREATEDBY': createdBy,
      'UPDATEDAT': updatedAt?.toIso8601String(), // Null check ekle
      'UPDATEDBY': updatedBy,
      'DELETEDAT': deletedAt?.toIso8601String(), // Null check ekle
      'DELETEDBY': deletedBy,
    };
  }
}
