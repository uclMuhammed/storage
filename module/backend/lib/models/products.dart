...
class Products extends IModel<Products> {
  ...
  factory Products.insert(
    ...
    return Products(
      ...
      barcode: barcode.toString().trim().toUpperCase(),
      ...
      unitId: unitId,
      price: 0,
      dimensions: dimensions.toString().trim().toUpperCase(),
      weight: weight,
      id: 0,
      isActive: false,
      isDelete: false,
  ...
  factory Products.fromJson(Map<String, dynamic> json) {
    ...
    return Products(
      ...
      barcode: json['BARCODE']?.toString().trim().toUpperCase() ?? '',
      ...
      dimensions: json['DIMENSIONS']?.toString().trim().toUpperCase() ?? '',
