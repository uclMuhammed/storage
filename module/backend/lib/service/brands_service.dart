...
class BrandsService extends BaseApiService<Brands> {
  ...
  Future<List<Brands>> getAll() async {
    try {
      ...
      //
      if (kDebugMode) {
        print('Brands Service GetAll Response Body : ${response.body}');
      }
      //
  ...
  Future<Brands> getById(int id) async {
    try {
      ...
      final apiResponse = ApiResponse<Brands>.fromJson(
        json.decode(response.body),
        (data) => (data as List).map((e) => Brands.fromJson(e)).first,
      );
      //
      return apiResponse.data;
      //
  ...
  Future<bool> delete(int id) async {
    try {
      ...
      //
      if (kDebugMode) {
        print('Brands Service Delete Response Body : ${response.body}');
      }
      //
      ...
      if (kDebugMode) {
        print(
            'Brands Service Delete Decoded Response : ${decodedResponse['data']}');
      }
      //
